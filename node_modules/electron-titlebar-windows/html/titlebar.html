<div class="titlebar">
    <div class="titlebar-controls">
        <div class="titlebar-minimize" title="Zoom (CTRL + / - / 0)">

                <button style="background-color: rgba(255, 255, 255, 0); padding: 5px 7px; border: 0px solid;" 
                    onclick="alert('Клик по лупе')">
                    <img style="width:13px; height:13px;" src="../img/zoopP.png" />
                </button>

        </div>
        <div class="titlebar-minimize" title="Over Windows (CTRL + D)">
                <button
                    style="background-color: rgba(255, 255, 255, 0);  border: 0px solid;"
                    onclick="altop()" >
                    <img style="width:13px; height:13px;" style="width:15px; height:15px;" src="../img/layer.png" />
                </button>
        </div>
        <div class="titlebar-minimize" title="Lock window (CTRL + E)">
           <button style="background-color: rgba(255, 255, 255, 0); padding: 5px 7px; border: 0px solid;"
                    onclick="mouse_ignore()">
                    <img style="width:13px; height:13px;" src="../img/lock.png" />
                </button>
        </div>
